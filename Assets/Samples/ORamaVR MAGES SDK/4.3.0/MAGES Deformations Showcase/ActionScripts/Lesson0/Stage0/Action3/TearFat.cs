...
public class TearFat : MonoBehaviour, IAction
{
    ...
    public void Undo()
    {
        BasePrototype.cameFromUndo = true;
        DestroySpawnedPrefabs();
    }
