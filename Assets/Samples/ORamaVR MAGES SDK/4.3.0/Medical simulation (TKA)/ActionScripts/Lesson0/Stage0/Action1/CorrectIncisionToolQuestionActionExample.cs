...
/// The developer can set multiple answers by modifying the question prefab. In this example we have four answers
/// </summary>
public class CorrectIncisionToolQuestionActionExample : QuestionAction
{
    /// <summary>
    ...
    public override void Initialize()
    {
        ...
        SetQuestionPrefab("Lesson0/Stage0/Action1/CorrectIncisionToolQuestionExample");
